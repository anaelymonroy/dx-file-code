...
<script>
    ...
    pagina_generar = `<!DOCTYPE html>\n<html lang='en'>\n<head>\n<link href='style.css' rel='stylesheet' type='text/css'>\n<meta charset='UTF-8'><title>Subir Archivo</title>\n<style>\n`+
                      ...
                      `         <span class='cannot-upload-message'> \n\t\t <span class='material-icons-outlined'>error</span> Seleccione primero el archivo  \n\t\t\t <span class='material-icons-outlined cancel-alert-button'>cancel</span>\n\t\t </span>\n`+
                      `         <span class='cannot-upload-message-error'>  \n\t\t <span class='material-icons-outlined'>error</span> Ocurrio un error al cargar el archivo \n\t\t\t <span class='material-icons-outlined cancel-alert-button2'>cancel</span>\n\t\t </span>\n`+
                      `         <div class='file-block'>\n\t\t<div class='file-info'> \n\t\t<span class='material-icons-outlined file-icon'>Descripcion</span> \n\t\t <span class='file-name'> </span> | <span class='file-size'>  </span>\n`+
    ...
    function buildObjects(input) {
        ...
        //let result = buildScript(output);
        //finalScript = "<script>" + result + "<" + "/" + "script>"
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    ...
                    <form on:submit={handleFormSubmit}>
                        ...
                        <button class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" type="submit">Generar Codigo</button>
                    </form>
